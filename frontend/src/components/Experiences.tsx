...
const ExperienceCard = ({ exp }: { exp: any }) => {
  ...
  return (
    <div className="group relative h-96 rounded-2xl overflow-hidden shadow-xl cursor-pointer bg-gray-200">
      ...
      <div className="absolute inset-0 p-8 flex flex-col justify-end transform transition-transform duration-300 group-hover:-translate-y-2">
